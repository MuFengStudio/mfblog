...
$PASSWORD = '$2y$10$29PKGPJqHVcXjOmUH8F.JOvkphCyVJtofTsTyO/scd6nG1S8Rl0bu';

error_reporting(0);
$VERSION = "8.23";
$HOST = "https://fileadmin.top";
$LOGIN = false;
...
case "stylesheet": header("content-type: text/css"); ?> /* <style> */
	...
	*:not(.textEditorContainer *)::-webkit-scrollbar{display:none;}
	...
	input:not(.textEditorContainer input),select,textarea:not(.textEditorContainer textarea),#totpForm{font-size:.95rem;padding:10px;width:100%;border-radius:5px;border:1px solid #DADADA;background:#F9F9FB;transition:border .2s,background .2s;margin:15px 0;caret-color:#1E9FFF;}
	...
	textarea{font-family:'微软雅黑';resize:vertical;}
	...
	div.checkbox::before{content:'\EB7B';font-family:'icon';background:#F9F9FB;color:transparent;border-radius:5px;width:15px;height:15px;display:flex;align-items:center;justify-content:center;border:1px solid #DADADA;transition:all .2s;margin-right:5px;font-size:.6em;padding-top:1px;}
	...
	.fullMode header{border-bottom:1px solid #F0F0F0;}
	...
	/* 窗口 */
	#tabsSwitcher{height:30px;background:#F0F0F0;overflow-x:scroll;overflow-y:hidden;font-size:0;white-space:nowrap;padding:3px 5px 3px 0;}
	#tabsSwitcher>div{vertical-align:top;}
	#tabsSwitcher .tab{height:24px;padding:0 8px 0 10px;font-size:14px;position:relative;margin-left:-1px;display:inline-flex;justify-content:center;align-items:center;opacity:.8;border-radius:3px;}
	...
	#tabsSwitcher .tab.active{background:white;opacity:1;}
	...
	/* 登录框 */
	.login{margin:auto;width:fit-content;height:fit-content;left:0;right:0;top:8px;padding:20px;width:340px;}
	...
	/* 文件管理 */
	#fileHeader{background:#F0F0F0;height:30px;display:flex;align-items:center;padding:0 10px;white-space:nowrap;}
	...
	#fileAddress{background:#F0F0F0;height:30px;padding:0 5px 5px 5px;}
	...
	#fileMenu{position:fixed;width:230px;overflow-y:scroll;padding:7px 0;border-radius:7px;display:none;background:rgba(255,255,255,.8);backdrop-filter:blur(20px);border:1px solid #CDCDCD;box-shadow:0 4px 6px rgba(0,0,0,.04);}
	...
	.dark input:not(.textEditorContainer input),.dark select,.dark textarea,.dark #totpForm{background:#1E1E1E;border:1px solid #323232;color:white;}
	.dark input:not(.textEditorContainer input):focus,.dark select:hover,.dark textarea:focus,.dark #totpForm:focus-within{background:black;border:1px solid #1E9FFF;}
	...
	.dark .dialogContainer .dialog{background:black;border:1px solid #323232;}
	.dark .dialogContainer>.dialog>.content>.fileAddressBar,.dark .dialogContainer>.dialog>.content>.fileList{background:#1E1E1E;}
	...
	.dark header .active{background:#1E9FFF;color:#F0F0F0;}
	.dark header .active:hover,.dark header .active:active{background:#0092FF;}
	.dark main>div{background:black;border:1px solid #323232;}
	.dark #tabsSwitcher{background:#1E1E1E;}
	.dark #tabsSwitcher .tab:hover{background:#323232;}
	.dark #tabsSwitcher .tab.active{background:black;border-top:1px solid #181818;}
	.dark #tabsSwitcher .tab::after{border-left:1px solid black;}
	.dark #fileHeader,.dark #fileAddress,.dark #refreshIndicator{background:#1E1E1E;}
	.dark .fileAddressBar{background:black;}
	...
	.dark #tabsContent .tabLayer{background:black;}
	...
	.dark .searchContainer>.searchOptions>div>div:focus-within{background:black;border:1px solid #1E9FFF;}
	.dark .searchContainer>.searchOptions>div>div>select>option{background:black;}
	.dark .searchContainer>.searchResult{background:#1E1E1E;}
	.dark .searchContainer>.searchResult>div>.lines{background:black;}
	...
	@media screen and (max-width: 600px){
		...
		.dark header{border-bottom:1px solid #1E1E1E;background:#1E1E1E;}
		...
		#fileMenu{display:block!important;top:calc(100% - 40px)!important;left:0!important;animation:none!important;margin:0;height:40px;border-radius:0;border:0!important;background:#EBEBEB;width:100%;padding:0;text-align:center;font-size:0;overflow-x:scroll;white-space:nowrap;}
		.dark #fileMenu{background:#1E1E1E!important;}
